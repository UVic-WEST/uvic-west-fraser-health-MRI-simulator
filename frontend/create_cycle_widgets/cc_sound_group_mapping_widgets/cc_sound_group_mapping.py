...
class CCSoundGroupMappingPage(QWidget):
    def __init__(self, controller, parent=None):
        ...
        self.print_btn = QPushButton("Default", self)
        self.print_btn.setGeometry(752, 536, 120, 44)
        ...
        self.print_btn.clicked.connect(self.default_button_pressed)
        ...
        self.page_status = QLabel("Are you sure you want to map sound groups?")
        page_status_font = QFont("Ubuntu", 24)
        self.page_status.setFont(page_status_font)
